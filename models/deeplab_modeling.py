from models.deeplab_utils import IntermediateLayerGetter
from models.deeplab import DeepLabHead, DeepLabHeadV3Plus, DeepLabV3
...
def _segm_resnet(name, backbone_name, num_classes, output_stride, pretrained_backbone, input_channels):
...
def _load_model(arch_type, backbone, num_classes, output_stride, pretrained_backbone, input_channels=3):

    if backbone=='mobilenetv2':
        model = _segm_mobilenet(arch_type, backbone, num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone)
    elif backbone.startswith('resnet'):
        model = _segm_resnet(arch_type, backbone, num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone, input_channels=input_channels)
...
def deeplabv3_resnet101(num_classes=21, output_stride=8, pretrained_backbone=True, input_channels=3):
    ...
    Args:
        ...
        pretrained_backbone (bool): If True, use the pretrained backbone.
    """
    return _load_model('deeplabv3', 'resnet101', num_classes, output_stride=output_stride, pretrained_backbone=pretrained_backbone, input_channels=input_channels)
