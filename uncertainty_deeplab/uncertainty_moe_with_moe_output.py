...
class Severity0MoEEvaluator:
    ...
    def __init__(self, model, modelname: str):
        ...
        root = os.path.join(DATASET_ROOT, "highway")
    ...
    def validation(self):
        ...
        for i, sample in enumerate(tbar):
            ...
            output_tensor = torch.stack([output, expert1_out, expert2_out])
            ...
            for j in range(batch_size):
                ...
                if image_index in [0]:  # highway, ambiguous at index 0, urban at index 45
                    ...
                    #     pred=pred_tensor,
                    #     label=label_tensor,
                    #     uncertainty=1-evu_conf[j],
                    #     modelname=f"moe_ambiguous_evu",
                    #     image_index=image_index,
                    #     dropout_rate=0.0,
                    #     predictive_entropy=None,
                    #     mutual_information=None,
...
if __name__ == "__main__":
    ...
    models_to_test = [
        ...
        #  },
        # {
        #     "name": "moe_simple_final_conv_ambiguous_wih_moe_output",
        #     "model": MoE(
        #         gate_type="simple",
        #         with_conv=True,
        #         arch="deeplabv3plus",
